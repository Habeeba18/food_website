<%-- 
    Document   : admin_user_index
    Created on : 22 Oct, 2021, 5:09:28 PM
    Author     : yasee
--%>
    ...
    <body>
        ...
        <div class="header">
            ...
            <div class="container">
                <div class="navbar">
                    <div class="logo">
                       <img src="images/fq img.jpg" width="200px" height="60px">
            </div>
            <nav><center>
...
<!--        <li><a href="adminpostindex.html" >Manage Items</a></li>-->
        <li><a href="admin_user_index.jsp">Manage users</a></li>
            <li><a href="admin_add_item.jsp" >Manage Items</a></li>
          <li><a href="admin_order.jsp">Manage Order Details </a></li>
                ...
                <div class="content">
                    ...
                    <table>
                        ...
                        <%
                            ...
                            ArrayList<student> a1 = s1.getuserdata();
