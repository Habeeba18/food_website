<%-- 
    Document   : myorders
    Created on : 10 Oct, 2021, 4:02:58 PM
    Author     : yasee
--%>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <%
                                ...
                                ArrayList<Order> a1 = s1.getorderinfo();
                                Iterator<Order> itr = a1.iterator();
                                while (itr.hasNext()) {
                                    Order s = itr.next();
                            %> 
                            <%
                            ...
                            %> 
                            <tr> 
                                <td><img src="image/<%=s3.getc_image()%>" width="100px" height="100px"></td>
                                <td><%=s3.getc_name()%></td>
                                <td><%=s3.getc_cost()%></td>
                                <td><%=s3.getstatus()%></td>
                            </tr>
                        ...
                        <td>
                            ...
                            <form action="order" method="post">
                                <input type="hidden" name="order_id" value="<%=s.getoid()%>"/>
